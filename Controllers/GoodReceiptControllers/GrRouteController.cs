...
namespace WMS_WEBAPI.Controllers
{
    ...
    public class GrRouteController : ControllerBase
    {
        ...
        [HttpGet("paged")]
        public async Task<ActionResult<ApiResponse<PagedResponse<GrRouteDto>>>> GetPaged([FromQuery] int pageNumber = 1, [FromQuery] int pageSize = 10, [FromQuery] string? sortBy = null, [FromQuery] string? sortDirection = "asc")
        {
